...
{
    public class BitMaxCashPlaceOrder
    {
        ...
        [JsonProperty("timeInForce", NullValueHandling = NullValueHandling.Ignore), JsonConverter(typeof(CashOrderTimeInForceConverter))]
        public BitMaxCashOrderTimeInForce? TimeInForce { get; set; }
    }
}